...
///     Source: <see href="https://learn.microsoft.com/en-us/openapi/kiota/tutorials/dotnet-dependency-injection#create-extension-methods" />.
/// </summary>
internal static class KiotaServiceExtensions
{
    /// <summary>
    ...
    /// <remarks>
    ///     The handlers are added to the http client by the <see cref="AttachKiotaHandlers(IHttpClientBuilder)" /> call, which requires them
    ///     to be pre-registered in DI
    /// </remarks>
